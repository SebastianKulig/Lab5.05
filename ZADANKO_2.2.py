# TODO Tutaj przeklej kod z pliku ZADANKO_2.py.
#  Idea klienta opiera się na uniwersalności, stąd też każdy klient będzie posiadał ten sam kod.
